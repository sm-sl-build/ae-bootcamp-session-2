...
- [UI Guidelines](../docs/ui-guidelines.md) - Core UI guidelines for the app
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles and best practices for the project
